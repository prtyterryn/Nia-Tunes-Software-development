    ...
    <div className="min-h-screen bg-nia-black flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        <div className="mb-8 text-center">
          <div className="w-20 h-20 bg-gradient-to-br from-nia-red to-nia-green rounded-3xl flex items-center justify-center mx-auto mb-4 shadow-glow">
            <Music className="w-10 h-10 text-white" />
          </div>
          <h1 className="text-3xl font-bold text-white mb-2">NiaTunes</h1>
          <p className="text-nia-gray-400">Rhythm of a nation</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-sm space-y-4">
          {/* Error Message */}
          {authError && (
            <div className="p-3 bg-nia-red/20 border border-nia-red/30 rounded-xl text-nia-red text-sm text-center animate-shake">
              {authError}
            </div>
          )}
          ...
          {!isLogin && (
            <div>
              ...
              {errors.name && (
                <p className="text-nia-red text-xs mt-1 ml-1">{errors.name}</p>
              )}
            </div>
          )}
          ...
          <div>
            ...
            {errors.email && (
              <p className="text-nia-red text-xs mt-1 ml-1">{errors.email}</p>
            )}
          </div>
          ...
          <div>
            ...
            {errors.password && (
              <p className="text-nia-red text-xs mt-1 ml-1">{errors.password}</p>
            )}
          </div>
          ...
          {isLogin && (
            <div className="text-right">
              <button type="button" className="text-nia-red text-sm hover:underline">
                Forgot password?
              </button>
            </div>
          )}
        ...
        <div className="w-full max-w-sm mt-8">
          <div className="flex items-center gap-4 mb-6">
            <div className="flex-1 h-px bg-nia-gray-800" />
            <span className="text-nia-gray-400 text-sm">Or continue with</span>
            <div className="flex-1 h-px bg-nia-gray-800" />
          </div>

          <div className="flex gap-4">
            <button className="flex-1 flex items-center justify-center gap-2 p-3 glass-card rounded-xl hover:bg-white/10 transition-colors">
